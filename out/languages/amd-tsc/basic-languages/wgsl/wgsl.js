...
define(["require", "exports"], function (require, exports) {
    ...
    exports.language = {
        ...
        keywords: keywords,
        reserved: reserved,
        predeclared_enums: predeclared_enums,
        predeclared_types: predeclared_types,
        predeclared_type_generators: predeclared_type_generators,
        predeclared_type_aliases: predeclared_type_aliases,
        predeclared_intrinsics: predeclared_intrinsics,
        operators: operators,
        symbols: /[!%&*+\-\.\/:;<=>^|_~,]+/,
        tokenizer: {
            root: [
