...
define(["require", "exports", "../_.contribution", "assert", "../../fillers/monaco-editor-core", "../monaco.contribution"], function (require, exports, __contribution_1, assert, monaco_editor_core_1) {
    ...
    function testTokenization(_language, tests) {
        ...
        test(mainLanguage + ' tokenization', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all(languages.map(function (l) { return (0, __contribution_1.loadLanguage)(l); }))];
                    case 1:
                        _a.sent();
    ...
    function runTest(languageId, test) {
        ...
        var actualTokens = monaco_editor_core_1.editor.tokenize(text, languageId);
