...
define(["require", "exports", "../../fillers/monaco-editor-core"], function (require, exports, monaco_editor_core_1) {
    ...
    exports.conf = {
        ...
        onEnterRules: __spreadArray([
            {
                beforeText: /^\s*- .+/,
                action: { indentAction: monaco_editor_core_1.languages.IndentAction.None, appendText: '- ' }
            },
            {
                beforeText: /^\s*\+ .+/,
                action: { indentAction: monaco_editor_core_1.languages.IndentAction.None, appendText: '+ ' }
            ...
            action: { indentAction: monaco_editor_core_1.languages.IndentAction.None, appendText: "".concat(index + 1, ". ") }
        }); }), true)
    };
    exports.language = {
        defaultToken: '',
