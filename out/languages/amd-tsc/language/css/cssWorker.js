...
define(["require", "exports", "vscode-css-languageservice"], function (require, exports, cssService) {
    ...
    var CSSWorker = /** @class */ (function () {
        function CSSWorker(ctx, createData) {
            ...
            var lsOptions = {
                customDataProviders: customDataProviders,
        ...
        CSSWorker.prototype.format = function (uri, range, options) {
            return __awaiter(this, void 0, void 0, function () {
                var document, settings, textEdits;
                return __generator(this, function (_a) {
                    document = this._getTextDocument(uri);
                    if (!document) {
                        return [2 /*return*/, []];
                    }
                    settings = __assign(__assign({}, this._languageSettings.format), options);
                    textEdits = this._languageService.format(document, range /* TODO */, settings);
