...
define(["require", "exports", "./lib/typescriptServices", "./lib/lib"], function (require, exports, ts, lib_1) {
    ...
    var TypeScriptWorker = /** @class */ (function () {
        ...
        TypeScriptWorker.prototype.getEmitOutput = function (fileName, emitOnlyDtsFiles, forceDtsEmit) {
            return __awaiter(this, void 0, void 0, function () {
                var emitOutput, diagnostics;
                return __generator(this, function (_a) {
                    if (fileNameIsLib(fileName)) {
                        return [2 /*return*/, { outputFiles: [], emitSkipped: true }];
                    }
                    emitOutput = this._languageService.getEmitOutput(fileName, emitOnlyDtsFiles, forceDtsEmit);
                    diagnostics = emitOutput.diagnostics
                        ? TypeScriptWorker.clearFiles(emitOutput.diagnostics)
                        : undefined;
                    return [2 /*return*/, __assign(__assign({}, emitOutput), { diagnostics: diagnostics })];
                });
            });
        };
