...
define(["require", "exports", "./monaco.contribution", "./lib/lib.index", "../../fillers/monaco-editor-core"], function (require, exports, monaco_contribution_1, lib_index_1, monaco_editor_core_1) {
    ...
    // --- occurrences ------
    var DocumentHighlightAdapter = /** @class */ (function (_super) {
        __extends(DocumentHighlightAdapter, _super);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, worker.getDocumentHighlights(resource.toString(), offset, [
                                    resource.toString()
                                ])];
                        case 2:
                            entries = _a.sent();
                            ...
                            return [2 /*return*/, entries.flatMap(function (entry) {
                                    return entry.highlightSpans.map(function (highlightSpans) {
                                        return {
                                            range: _this._textSpanToRange(model, highlightSpans.textSpan),
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, worker.getNavigationTree(resource.toString())];
                        case 2:
                            root = _a.sent();
                            if (!root || model.isDisposed()) {
                                return [2 /*return*/];
                            }
                            convert = function (item, containerLabel) {
                                var _a;
                                var result = {
                                    name: item.text,
                                    detail: '',
                                    ...
                                    tags: [],
                                    children: (_a = item.childItems) === null || _a === void 0 ? void 0 : _a.map(function (child) { return convert(child, item.text); }),
                                    containerName: containerLabel
                                };
                                return result;
                            };
                            result = root.childItems ? root.childItems.map(function (item) { return convert(item); }) : [];
                            return [2 /*return*/, result];
                    }
                });
            });
    ...
    var FormatAdapter = /** @class */ (function (_super) {
        ...
        function FormatAdapter() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.canFormatMultipleRanges = false;
            return _this;
        }
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            hints = tsHints.map(function (hint) {
                                return __assign(__assign({}, hint), { label: hint.text, position: model.getPositionAt(hint.position), kind: _this._convertHintKind(hint.kind) });
                            });
                            return [2 /*return*/, { hints: hints, dispose: function () { } }];
                    }
                });
            });
        };
