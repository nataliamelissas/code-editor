...
define(["require", "exports"], function (require, exports) {
    ...
    exports.libFileSet['lib.decorators.d.ts'] = true;
    exports.libFileSet['lib.decorators.legacy.d.ts'] = true;
    exports.libFileSet['lib.dom.asynciterable.d.ts'] = true;
    ...
    exports.libFileSet['lib.es2016.intl.d.ts'] = true;
    exports.libFileSet['lib.es2017.d.ts'] = true;
    exports.libFileSet['lib.es2017.date.d.ts'] = true;
    ...
    exports.libFileSet['lib.es2019.intl.d.ts'] = true;
    ...
    exports.libFileSet['lib.es2020.date.d.ts'] = true;
    exports.libFileSet['lib.es2020.full.d.ts'] = true;
    exports.libFileSet['lib.es2020.intl.d.ts'] = true;
    exports.libFileSet['lib.es2020.number.d.ts'] = true;
    ...
    exports.libFileSet['lib.es2021.intl.d.ts'] = true;
    ...
    exports.libFileSet['lib.es2022.array.d.ts'] = true;
    exports.libFileSet['lib.es2022.d.ts'] = true;
    exports.libFileSet['lib.es2022.error.d.ts'] = true;
    exports.libFileSet['lib.es2022.full.d.ts'] = true;
    exports.libFileSet['lib.es2022.intl.d.ts'] = true;
    exports.libFileSet['lib.es2022.object.d.ts'] = true;
    exports.libFileSet['lib.es2022.regexp.d.ts'] = true;
    exports.libFileSet['lib.es2022.sharedmemory.d.ts'] = true;
    exports.libFileSet['lib.es2022.string.d.ts'] = true;
    exports.libFileSet['lib.es2023.array.d.ts'] = true;
    exports.libFileSet['lib.es2023.collection.d.ts'] = true;
    exports.libFileSet['lib.es2023.d.ts'] = true;
    exports.libFileSet['lib.es2023.full.d.ts'] = true;
    exports.libFileSet['lib.es5.d.ts'] = true;
    exports.libFileSet['lib.es6.d.ts'] = true;
    exports.libFileSet['lib.esnext.collection.d.ts'] = true;
    exports.libFileSet['lib.esnext.d.ts'] = true;
    exports.libFileSet['lib.esnext.decorators.d.ts'] = true;
    exports.libFileSet['lib.esnext.disposable.d.ts'] = true;
    exports.libFileSet['lib.esnext.full.d.ts'] = true;
    exports.libFileSet['lib.esnext.intl.d.ts'] = true;
    exports.libFileSet['lib.esnext.object.d.ts'] = true;
    exports.libFileSet['lib.esnext.promise.d.ts'] = true;
    exports.libFileSet['lib.scripthost.d.ts'] = true;
    exports.libFileSet['lib.webworker.asynciterable.d.ts'] = true;
