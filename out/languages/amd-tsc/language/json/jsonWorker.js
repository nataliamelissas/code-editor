...
define(["require", "exports", "vscode-json-languageservice", "vscode-uri"], function (require, exports, jsonService, vscode_uri_1) {
    ...
    var JSONWorker = /** @class */ (function () {
        ...
        JSONWorker.prototype.findDocumentSymbols = function (uri) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    jsonDocument = this._languageService.parseJSONDocument(document);
                    symbols = this._languageService.findDocumentSymbols2(document, jsonDocument);
        ...
        JSONWorker.prototype.parseJSONDocument = function (uri) {
            return __awaiter(this, void 0, void 0, function () {
                var document, jsonDocument;
                return __generator(this, function (_a) {
                    document = this._getTextDocument(uri);
                    ...
                    jsonDocument = this._languageService.parseJSONDocument(document);
                    return [2 /*return*/, Promise.resolve(jsonDocument)];
                });
            });
        };
        JSONWorker.prototype.getMatchingSchemas = function (uri) {
            return __awaiter(this, void 0, void 0, function () {
                var document, jsonDocument;
                return __generator(this, function (_a) {
                    document = this._getTextDocument(uri);
                    ...
                    jsonDocument = this._languageService.parseJSONDocument(document);
                    return [2 /*return*/, Promise.resolve(this._languageService.getMatchingSchemas(document, jsonDocument))];
                });
            });
        };
